        ...
        <div className="bg-white rounded-xl shadow-sm mb-8">
          <div className="flex border-b border-gray-200">
            <button
              ...
              className={`flex-1 py-4 px-6 text-center font-medium ${
                activeTab === "clinics" ? "text-blue-600 border-b-2 border-blue-600" : "text-gray-500 hover:text-gray-700"
              }`}
            >
            ...
            <button
              ...
              className={`flex-1 py-4 px-6 text-center font-medium ${
                activeTab === "hospitals" ? "text-blue-600 border-b-2 border-blue-600" : "text-gray-500 hover:text-gray-700"
              }`}
            >
              <div className="flex items-center justify-center gap-2">
          ...
          <div className="p-6">
            {activeTab === "clinics" && (
              <div>
                <div className="mb-6">
                  <h2 className="text-xl font-semibold text-gray-900 mb-3">查找附近诊所</h2>
            ...
            {activeTab === "hospitals" && (
              <div>
                <div className="mb-6">
                  <h2 className="text-xl font-semibold text-gray-900 mb-3">查找附近医院</h2>
                  <div className="flex gap-3">
                    <input
                      type="text"
                      placeholder="输入您的位置（例如邮政编码）"
            ...
            {activeTab === "appointments" && (
              <div className="max-w-2xl mx-auto">
                <h2 className="text-xl font-semibold text-gray-900 mb-6">预约医疗</h2>
                ...
                <div className="space-y-4">
                  <div className="border border-gray-200 rounded-lg p-5">
                    ...
                    <div className="flex flex-wrap gap-3">
                      <button className="px-4 py-2 bg-blue-100 text-blue-800 rounded-lg">健康诊所</button>
                      <button className="px-4 py-2 bg-gray-100 text-gray-800 rounded-lg">医院</button>
                      <button className="px-4 py-2 bg-gray-100 text-gray-800 rounded-lg">专科诊所</button>
                    </div>
                  </div>
                  ...
                  <div className="flex">
                    ...
                    <div className="ml-3">
                      ...
                      <div className="mt-2 text-sm text-yellow-700">
                        <p>• 为老年人提供COVID-19加强针</p>
                        <p>• 免费流感疫苗接种至2023年12月</p>
                      </div>
                    </div>
                  </div>
                </div>
